...
const styles = {
  ...
  kicker: { margin: 0, fontSize: 12, fontWeight: 800, letterSpacing: "0.12em", color: chatTheme.accent },
  title: { margin: "8px 0 10px", fontSize: 32, lineHeight: 1.15, color: chatTheme.text },
  description: { margin: 0, color: chatTheme.textMuted, fontSize: 15, lineHeight: 1.7, maxWidth: 640 },
  ...
  modeLabel: { fontSize: 18, fontWeight: 800, color: chatTheme.text, marginBottom: 6 },
  modeDescription: { fontSize: 13, color: chatTheme.textMuted, lineHeight: 1.5 },
  controls: {
    display: "flex",
    alignItems: "center",
    gap: 8,
  ...
  sectionLabel: { fontSize: 13, fontWeight: 800, color: chatTheme.textMuted },
  topicHint: { fontSize: 13, color: chatTheme.textMuted, lineHeight: 1.5 },
