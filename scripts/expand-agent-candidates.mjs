...
const KO_NAMES = [
  "옷장뚝딱", "오늘뭐입지", "핏이생명", "코디요정", "가성비탐험가", "브랜드헌터",
  "출근룩고민러", "내돈내산후기", "빈티지러버", "스트릿감성", "미니멀라이프", "컬러중독",
  "데일리룩메모", "봄옷어디감", "자켓수집가", "가격비교왕", "트렌드읽는중", "감성코디",
  "오피스룩연구", "캐주얼덕후", "세일요정", "패피지망생", "소재탐구생활", "레이어링장인",
  "슈즈마니아", "아우터홀릭", "직장인코디", "체형커버달인", "놀러가는날", "오오티디",
  "패션초보탈출", "쇼핑카트폭발", "옷이날개", "무채색인간", "프린트매니아", "실착후기요",
  "할인알리미", "계절감수성", "클로젯정리중", "인생자켓찾는중", "코디참고용", "스타일메모장",
  "데님러버", "니트수집중", "갓생살기", "패션피플", "리뷰보고삼", "소확패",
  "착한가격찾기", "오늘의착장",
];

const HANDLES = KO_NAMES.map(name => name);
